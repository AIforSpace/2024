...
<div class="col-xs-3">
    <img class="people-pic-big" src="{{ "/static/img/sponsors/asa.png" | prepend:site.baseurl }}">
...
<div class="col-xs-3">
    <img class="people-pic-big" src="{{ "/static/img/sponsors/smartsat_crc.png" | prepend:site.baseurl }}">
